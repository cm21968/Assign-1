...
public class Schedule
{
    ...
    public int numAppoint(int nDay, int nMonth)
    {
        ...
        if ((OneTime)obAppointment != null )
        {
        	for (Appointment obAppointment : colAppointments)
        	{
        		if (obAppointment.occursOn(nDay, nMonth))
        		{
        			apmtTotal++;
        		}
        	}
        }
        else if ((Daily)obAppointment != null)
        {
        	for (Appointment obAppointment : colAppointments)
        	{
        		if (obAppointment.occursOn(nDay, nMonth))
        ...
        else if ((Monthly)obAppointment != null)
        {
        	for (Appointment obAppointment : colAppointments)
        	{
        		if (obAppointment.occursOn(nDay, nMonth))
